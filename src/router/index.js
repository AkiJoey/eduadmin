...
export const constantRoutes = [
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'subject',
        name: 'Subject',
        component: () => import('@/views/education/subject'),
        meta: { title: '科目信息', icon: 'example' }
      }
    ]
  },
...

  {
    path: '/test',
    component: Layout,
    meta: { title: '习题管理', icon: 'example' },
    children: [
      {
        path: 'problem',
        name: 'Problem',
        component: () => import('@/views/test/problem'),
        meta: { title: '题目信息', icon: 'example' }
      },
      {
        path: 'test',
        name: 'Test',
        component: () => import('@/views/test/test'),
        meta: { title: '套题信息', icon: 'example' }
      }
    ]
  },
    ...
    children: [
      {
        path: 'attend',
        name: 'attend',
        component: () => import('@/views/attend/attend'),
